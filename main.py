...
def readData(path , start_year = 2008, end_year = 2020):
  return pd.concat([pd.read_json(path + '/prices_%d.json' %x) for x in range(start_year, end_year)])

def getAllTicker(dataFrame = readData('/content/drive/My Drive/DseDataSet'), start_date='2019-01-01', end_date='2019-12-31'):
  '''
...
def DSEModel(ticker, dataFrame = readData('/content/drive/My Drive/DseDataSet'),  start_date='2008-01-01', end_date='2018-12-31', growth='linear', changepoints=None, n_changepoints=25, 
